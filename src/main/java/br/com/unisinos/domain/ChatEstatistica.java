...
@Entity
public class ChatEstatistica implements Serializable {
    ...
    public ChatEstatistica() {
    	
    }
    
	public ChatEstatistica(Integer id, String usuario, String email, String msg) {
		super();
		this.id = id;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ChatEstatistica other = (ChatEstatistica) obj;
		if (id == null) {
			if (other.id != null)
				return false;
