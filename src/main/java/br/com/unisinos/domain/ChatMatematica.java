...
@Entity
public class ChatMatematica implements Serializable {
    ...
    public ChatMatematica() {
    	
    }
    
	public ChatMatematica(Integer id, String usuario, String email, String msg) {
		super();
		this.id = id;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ChatMatematica other = (ChatMatematica) obj;
		if (id == null) {
			if (other.id != null)
				return false;
